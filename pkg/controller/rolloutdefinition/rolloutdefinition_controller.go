...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileRolloutDefinition{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func (r *ReconcileRolloutDefinition) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	klog.Infof("qwkLog：Action rolloutDefinition reconcile %s/%s", rolloutDef.Namespace, rolloutDef.Name)
	...
	klog.Infof("qwkLog：fmt map:  %v : %v", contrlResource, r.pathTable[contrlResource])
